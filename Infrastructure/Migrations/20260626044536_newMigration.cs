        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderStatusHistories_Statuses_NewStatusId",
                        column: x => x.NewStatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderStatusHistories_Statuses_PreviousStatusId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Open", "Order" },
                    { 2, "InProgress", "Order" },
                    { 3, "ReadyToClose", "Order" },
                    { 4, "Closed", "Order" },
                    { 5, "Cancelled", "Order" },
                    { 6, "Pending", "OrderItem" },
                    { 7, "SentToKitchen", "OrderItem" },
                    { 8, "Ready", "OrderItem" },
                    { 9, "Delivered", "OrderItem" },
                    { 10, "Cancelled", "OrderItem" }
                });
